  ...
  <div class="box">
    <?php if (!empty($data['messages'])) : ?>
      <?php foreach ($data['messages'] as  $msg) : ?>
        <div class="hidden mt15 mb15<?php if (!$msg['unread'] > 0) : ?> bg-purple<?php endif; ?>">
          ...
          <div class="p15 br-rd5 mt5 relative bg-blue-100<?php if (!$msg['unread'] > 0) : ?> bg-purple<?php endif; ?> gray">
