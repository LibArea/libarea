...
<?php if ($item['post_closed'] == 1) : ?><span class="gray-600" title="<?= __('app.close'); ?>"><svg class="icon"><use xlink:href="#lock"></use></svg></span><?php endif; ?>
<?php if ($item['post_top'] == 1) : ?> <sup class="red"><svg class="icon"><use xlink:href="#pin"></use></svg></sup> <?php endif; ?>
<?php if ($item['post_lo']) : ?><span class="red"><svg class="icon"><use xlink:href="#selected"></use></svg></span><?php endif; ?>
...
<?php if ($item['post_hidden']) : ?> <svg class="icon gray-600"><use xlink:href="#eye"></use></svg> <?php endif; ?>
