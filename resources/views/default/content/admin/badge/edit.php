...
<div class="bg-white br-box-gray p15 max-w780">
  <form action="/admin/badge/edit/<?= $data['badge']['badge_id']; ?>" method="post">
    ...
    <div class="mb20">
      ...
      <div class="size-14 gray-400">4 - 25 <?= Translate::get('characters'); ?></div>
    </div>
    <div class="mb20">
      <label class="block" for="post_title">Icon</label>
      <textarea class="add" name="badge_icon" required><?= $data['badge']['badge_icon']; ?></textarea>
      <div class="size-14 gray-400"><?= Translate::get('for example'); ?>: &lt;i title="<?= Translate::get('title'); ?>" class="bi bi-trophy"&gt;&lt;/i&gt; </div>
    </div>
    <div class="mb20">
      ...
      <div class="size-14 gray-400"><?= Translate::get('for'); ?> TL (0 <?= Translate::get('by default'); ?>)</div>
    </div>
    <div class="mb20">
      ...
      <div class="size-14 gray-400"><?= Translate::get('reward weight'); ?></div>
    </div>
    <div class="mb20">
      ...
      <div class="size-14 gray-400">12 - 250 <?= Translate::get('characters'); ?></div>
    </div>
