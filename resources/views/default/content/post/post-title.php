...
<?php if ($post['post_closed'] == 1) { ?><i class="bi-lock gray-600"></i><?php } ?>
<?php if ($post['post_top'] == 1) { ?><i class="bi-pin-angle sky"></i><?php } ?>
<?php if ($post['post_lo'] > 0) { ?><i class="bi-award sky"></i><?php } ?>
<?php if ($post['post_feature'] == 1) { ?><i class="bi-patch-question green"></i><?php } ?>
<?php if ($post['post_translation'] == 1) { ?>
  <?php if ($post['post_merged_id'] > 0) { ?><i class="bi-link-45deg sky"></i><?php } ?>
