<?php if ($post['post_is_deleted'] == 1) { ?><i class="bi-trash red-500"></i><?php } ?>
...
<?php if ($post['post_feature'] == 1) { ?><i class="bi-patch-question green-600"></i><?php } ?>
...
<?php } ?>
<?php if ($post['post_tl'] > 0) { ?><span class="yellow-500 italic text-sm">tl<?= $post['post_tl']; ?></span><?php } ?>