...
$facet_view_policy = $blog['facet_view_policy'] ?? null;
?>

<?php if ($facet_view_policy == false || is_array($data['facet_signed']) == true) : ?>
...
<?php else : ?>
  <main>
    ...
    <div class="center">
      ...
      <a title="<?= $blog['facet_title']; ?>" class="mb15 block" href="/blog/<?= $blog['facet_slug']; ?>">
        <?= $blog['facet_title']; ?>
      </a>
