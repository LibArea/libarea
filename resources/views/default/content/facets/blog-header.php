<div class="br-gray bg-white mb15 relative">
  <?= Img::image($data['facet']['facet_img'], htmlEncode($data['facet']['facet_title']), 'img-2xl mt20 mb-mt25 mb-img-2xl profile-ava', 'logo', 'max'); ?>
  <div class="relative hidden">
    <img class="box-cover-img" src="<?= Img::cover($data['facet']['facet_cover_art'], 'blog'); ?>" alt="<?= htmlEncode($data['facet']['facet_title']); ?>">
  </div>
  <div class="flex justify-between mt20">
    <h1 class="mb-block mb-text-xl mt20 ml15 mb-mt5">
      <?= htmlEncode($data['facet']['facet_title']); ?>
