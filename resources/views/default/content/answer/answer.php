        ...
        <div class="flex text-sm">
          ...
          <?php if ($answer['post_closed'] == 0) { ?>
            <?php if ($answer['post_is_deleted'] == 0 || UserData::checkAdmin()) { ?>
              <a data-post_id="<?= $answer['post_id']; ?>" data-answer_id="<?= $answer['answer_id']; ?>" class="add-comment gray-500 mr5 ml10"><?= Translate::get('reply'); ?></a>
            <?php } ?>
          <?php } ?>
          ...
          <?php if ($user['id'] != $answer['answer_user_id'] && $user['trust_level'] > Config::get('trust-levels.tl_stop_report')) { ?>
            <a data-post_id="<?= $answer['post_id']; ?>" data-type="answer" data-content_id="<?= $answer['answer_id']; ?>" class="msg-flag gray-500 ml15">
