...
<main class="col-span-8 bg-white br-rd-5 border-box-1 pt10 pr15 pb5 pl15">
    ...
    <?php if (Config::get('general.search') == 0) { ?>
      <?php foreach ($data['result'] as  $post) { ?>
        <div class="search max-w780 mb20 pb20">
          ...
          <?= html_topic($post['topic_list'], 'topic', 'bg-blue-100 bg-hover-300 white-hover flex justify-center pt5 pr10 pb5 pl10 br-rd-5 mb5 mr10 blue inline size-14'); ?>
