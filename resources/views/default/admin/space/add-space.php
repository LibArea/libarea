                ...
                <div class="telo space">
                    <div class="box create">
                        <form action="/admin/addspaceadmin" method="post" enctype="multipart/form-data">
                            ...
                            <div class="boxline">
                                <label class="form-label" for="post_content">Sidebar<sup class="red">*</sup></label>
