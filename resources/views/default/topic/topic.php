...
<main class="col-span-7 mb-col-12">
  <div class="bg-white br-rd5 br-box-gray mb15 p15">
    <div class="flex flex-row items-center justify-between">
      <div class="no-mob">
        <?= topic_logo_img($topic['topic_img'], 'max', $topic['topic_title'], 'w94 br-box-gray mt5'); ?>
      </div>
        ...
        <div class="mt15 right">
          <?php if (!$uid['user_id']) { ?>
            <a href="<?= getUrlByName('login'); ?>">
              <div class="bg-gray-200 bg-hover-gray mazarine br-box-gray inline br-rd20 center pt5 pr15 pb5 pl15">+ <?= Translate::get('read'); ?></div>
            </a>
          <?php } else { ?>
            <?php if (is_array($data['topic_signed'])) { ?>
              <div data-id="<?= $topic['topic_id']; ?>" data-type="topic" class="focus-id bg-gray-100 gray-light-2 br-box-gray inline br-rd20 center pt5 pr15 pb5 pl15">
                <?= Translate::get('unsubscribe'); ?>
              </div>
            <?php } else { ?>
              <div data-id="<?= $topic['topic_id']; ?>" data-type="topic" class="focus-id bg-gray-200 bg-hover-gray mazarine br-box-gray inline br-rd20 center pt5 pr15 pb5 pl15">
                + <?= Translate::get('read'); ?>
              </div>
            <?php } ?>
          <?php } ?>
