<div class="wrap">
  <main>
    <div class="white-box pt5 pr15 pb5 pl15">
        ...
        <div class="oblong-box-list topic-box-list pb15">
          <?php foreach ($data['topics'] as $topic) { ?>
            <div class="oblong-box relative">
              <a title="<?= $topic['topic_title']; ?>" class="absolute mt10 left-5" href="<?= getUrlByName('topic', ['slug' => $topic['topic_slug']]); ?>">
      ...
      <?php } else { ?>
        <?= returnBlock('no-content', ['lang' => 'Topics no']); ?>
      <?php } ?>
    ...
    <?php if (!empty($data['news'])) { ?>
      <div class="white-box p15">
        ...
        <?php foreach ($data['news'] as $new) { ?>
          <a title="<?= $new['topic_title']; ?>" class="tags gray size-13" href="<?= getUrlByName('topic', ['slug' => $new['topic_slug']]); ?>">
            <?= $new['topic_title']; ?>
          </a><br>
        <?php } ?>
      </div>
