<footer class="col-span-12 max-width mr-auto w-100 pr10 pb15 pl10 grid grid-cols-12 bg-gray-800 clear">
    <div class="text-info col-span-3 left no-mob ml10">
      <h4 class="mb5 uppercase font-light white"><?= Translate::get('info'); ?></h4>
    ...
    <div class="text-info col-span-3 no-mob">
      <h4 class="mb5 uppercase font-light white"><?= Translate::get('other'); ?></h4>
    ...
    <div class="text-info col-span-3 no-mob">
      <h4 class="mb5 uppercase font-light white"><?= Translate::get('help'); ?></h4>
    ...
    <div class="text-info col-span-3 mb-col-12">
      <h4 class="mb5 uppercase font-light white"><?= Translate::get('social networks'); ?></h4>
