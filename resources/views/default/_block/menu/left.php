<nav class="justify-between mt10 ml0 pl0 top70 sticky size-14 max-w200">
  <?php foreach (Config::get('menu-left') as  $menu) { ?>
    <a class="pt5 pb5 pl10 flex flex-row items-center gray bg-hover-light<?= $sheet == $menu['item'] ? ' blue' : ''; ?>" <?= $sheet == $menu['item'] ? ' aria-current="page" ' : ''; ?> title="<?= $menu['name']; ?>" href="<?= $menu['url']; ?>">
