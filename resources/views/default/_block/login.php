<div class="border-box-1 p15 mb15 br-rd-3 bg-white size-14">
    <form class="" action="<?= getUrlByName('login'); ?>" method="post">
      ...
      <div class="mb20">
        ...
        <input type="email" id="email" placeholder="<?= lang('enter'); ?>  e-mail" name="email" class="form-input">
      </div>
      <div class="mb20">
        <label for="password" class="form-label"><?= lang('password'); ?></label>
        <input type="password" id="password" placeholder="<?= lang('enter your password'); ?>" name="password" class="form-input">
      </div>
