...
return [
    ['id' => 1, 'icon' => 'bi-envelope green', 'lang' => 'notif_add_pm'],
    ['id' => 2, 'icon' => 'bi-lightbulb', 'lang' => 'notif_add_post'],
    ['id' => 3, 'icon' => 'bi-reply gray-600', 'lang' => 'notif_add_answer'],
    ['id' => 4, 'icon' => 'bi-chat-dots', 'lang' => 'notif_add_comment'],

    ['id' => 5, 'icon' => 'bi-chat-quote', 'lang' => 'notif_add_comment_comment'],

    ['id' => 6, 'icon' => 'bi-lightbulb', 'lang' => 'notif_like_post'],
    ['id' => 7, 'icon' => 'bi-lightbulb', 'lang' => 'notif_like_answer'],
    ['id' => 8, 'icon' => 'bi-lightbulb', 'lang' => 'notif_like_comment'],

    ['id' => 10, 'icon' => 'bi-person', 'lang' => 'notif_references_post'],
    ['id' => 11, 'icon' => 'bi-person', 'lang' => 'notif_references_amswer'],
    ['id' => 12, 'icon' => 'bi-person', 'lang' => 'notif_references_comment'],

    ['id' => 20, 'icon' => 'bi-exclamation-diamond red', 'lang' => 'notif_add_flag'],
    ['id' => 21, 'icon' => 'bi-exclamation-diamond red', 'lang' => 'notif_add_audit'],

    ['id' => 30, 'icon' => 'bi-link-45deg sky', 'lang' => 'notif_add_website'],
    ['id' => 31, 'icon' => 'bi-link-45deg sky', 'lang' => 'notif_edit_website'],
    ['id' => 32, 'icon' => 'bi-link-45deg sky', 'lang' => 'notif_approved_website'],
    ['id' => 33, 'icon' => 'bi-link-45deg sky', 'lang' => 'notif_add_website_subscription'],
    ['id' => 34, 'icon' => 'bi-link-45deg sky', 'lang' => 'notif_add_website_comment'],
    ['id' => 35, 'icon' => 'bi-link-45deg sky', 'lang' => 'notif_add_website_comment_reply'],
    ['id' => 35, 'icon' => 'bi-link-45deg sky', 'lang' => 'notif_add_website_comment_references'],
];
