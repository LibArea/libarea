...
CREATE TABLE `answers` (
  ...
  `answer_modified` timestamp NOT NULL DEFAULT '2020-12-29 18:00:00',
...
(1, 3, 1, '2021-04-28 13:41:27', '2020-12-29 18:00:00', 1, 0x3132372e302e302e31, 0, 0, 0, 'Первый ответ в теме', 0, 0),
(2, 1, 2, '2021-06-30 16:34:52', '2021-08-15 07:50:53', 1, 0x3132372e302e302e31, 0, 0, 0, 'Интересно, спасибо. Вы забыли указать, что можно задавать вопросы в чате (ссылка в footer) этого сайта.', 0, 0);
...
CREATE TABLE `comments` (
  ...
  `comment_modified` timestamp NOT NULL DEFAULT '2020-12-29 18:00:00',
...
(1, '2021/c-1638777119.webp', 'post', 0, 1, '2021-12-05 22:52:00', 0);
...
(4, '2021-10-26 09:24:03', 1, 'Firefox 93.0', 'Windows', '127.0.0.1'),
(5, '2021-11-04 20:01:34', 1, 'Firefox 94.0', 'Windows', '127.0.0.1'),
(6, '2021-12-05 12:38:15', 1, 'Firefox 94.0', 'Windows', '127.0.0.1'),
(7, '2021-12-05 22:51:36', 1, 'Firefox 94.0', 'Windows', '127.0.0.1'),
(8, '2021-12-07 18:25:29', 1, 'Firefox 95.0', 'Windows', '127.0.0.1'),
(9, '2021-12-07 19:15:41', 2, 'Firefox 95.0', 'Windows', '127.0.0.1'),
(10, '2021-12-08 01:40:13', 1, 'Firefox 95.0', 'Windows', '127.0.0.1'),
(11, '2021-12-08 01:49:18', 2, 'Firefox 95.0', 'Windows', '127.0.0.1'),
(12, '2021-12-22 11:03:39', 1, 'Firefox 95.0', 'Windows', '127.0.0.1'),
(13, '2021-12-22 11:08:44', 1, 'Firefox 95.0', 'Windows', '127.0.0.1'),
(14, '2021-12-22 11:09:08', 1, 'Firefox 95.0', 'Windows', '127.0.0.1'),
(15, '2022-02-10 05:50:18', 1, 'Firefox 96.0', 'Windows', '127.0.0.1');
