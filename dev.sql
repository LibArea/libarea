...
CREATE TABLE `answers` (
  ...
  `answer_modified` timestamp NOT NULL DEFAULT '2020-12-29 21:00:00',
...
(1, 3, 1, '2021-04-28 16:41:27', '2020-12-29 21:00:00', 1, 0x3132372e302e302e31, 0, 0, 0, 'Первый ответ в теме', 0, 0),
(2, 1, 2, '2021-06-30 19:34:52', '2021-08-15 10:50:53', 1, 0x3132372e302e302e31, 0, 0, 0, 'Интересно, спасибо. Вы забыли указать, что можно задавать вопросы в чате (ссылка в footer) этого сайта.', 0, 0);
...
CREATE TABLE `comments` (
  ...
  `comment_modified` timestamp NOT NULL DEFAULT '2020-12-29 21:00:00',
...
(1, '2021/c-1638777119.webp', 'post', 0, 1, '2021-12-06 01:52:00', 0);
...
INSERT INTO `items` (`item_id`, `item_url`, `item_url_domain`, `item_title_url`, `item_content_url`, `item_title_soft`, `item_content_soft`, `item_published`, `item_user_id`, `item_date`, `item_type_url`, `item_status_url`, `item_status_date`, `item_is_soft`, `item_is_github`, `item_github_url`, `item_post_related`, `item_votes`, `item_count`, `item_is_deleted`) VALUES
(1, 'https://agouti.ru', 'agouti.ru', '«Agouti» — сообщество по интересам', 'Лучшие публикации за сутки. Темы, личные дневники, группы...', 'Agouti', 'Discussion (forum) and Q&A platform. Community based on PHP Micro-Framework HLEB. (Zhihu, Quora clone)', 1, 1, '2021-06-20 19:35:02', 0, 200, '2021-06-20 19:35:02', 1, 1, 'https://github.com/AgoutiDev/agouti', '2', 1, 1, 0),
(2, 'https://github.com', 'github.com', '«GitHub» — веб-сервис для хостинга IT-проектов', 'Веб-сервис, хостинговая платформа  для программистов основанная на системе контроля версий Git. Бесплатные, платные версии репозитория.', '', '', 1, 1, '2021-11-02 23:30:40', 0, 200, '2021-11-02 23:30:40', 0, 0, '', '', 1, 1, 0),
(3, 'https://phphleb.ru', 'phphleb.ru', '«HLEB» — микрофреймворк', 'Документация и описание Micro-Framework(а) использующий базовую реализацию MVC на PHP. Установить, настройка, структура проекта. Маршрутизация, контроллеры и модели.', 'HLEB', 'Отличительной особенностью микропрограммы HLEB является минимализм кода и скорость работы. Выбор данного фреймворка позволяет запустить полноценный продукт с минимальными временными затратами и обращениями к документации; это легко, просто и быстро. \r\n\r\nВ то же время он решает типовые задачи, такие как маршрутизация, перенос действий на контроллеры, поддержка модели, то есть базовая реализация MVC. Это самый минимум, необходимый для быстрого запуска приложения.', 1, 1, '2021-11-08 08:02:24', 0, 200, '2021-11-08 08:02:24', 1, 1, 'https://github.com/phphleb/hleb', '', 1, 1, 0),
(4, 'https://ispserver.ru', 'ispserver.ru', '«ISPserveru» — хостинг-провайдер', 'Веб-хостинг, VPS и выделенные серверы в трёх дата-центрах в Москве и Германии. Информация по панели управления ISPmanager. Контакты, обратная связь.', '', '', 1, 1, '2021-11-12 06:50:54', 0, 200, '2021-11-12 06:50:54', 0, 0, '', '', 1, 1, 0),
(5, 'https://sourceforge.net', 'sourceforge.net', '«Sourceforge» — проекты с открытым исходным кодом', 'Список проектов с открытым исходным кодом. Перечень проектов, нуждающиеся в помощи. Возможность загрузить различные материалы. Информация на английском языке.', '', '', 1, 1, '2021-11-12 07:12:18', 0, 200, '2021-11-12 07:12:18', 0, 0, '', '', 1, 1, 0);
...
(1, '2021-09-20 13:09:38', 1, 'Firefox 92.0', 'Windows', '127.0.0.1'),
(2, '2021-09-20 13:57:57', 2, 'Chrome 93.0.4577.82', 'Windows', '127.0.0.1'),
(3, '2021-10-18 07:43:05', 1, 'Firefox 93.0', 'Windows', '127.0.0.1'),
(4, '2021-10-26 12:24:03', 1, 'Firefox 93.0', 'Windows', '127.0.0.1'),
(5, '2021-11-04 23:01:34', 1, 'Firefox 94.0', 'Windows', '127.0.0.1'),
(6, '2021-12-05 15:38:15', 1, 'Firefox 94.0', 'Windows', '127.0.0.1'),
(7, '2021-12-06 01:51:36', 1, 'Firefox 94.0', 'Windows', '127.0.0.1'),
(8, '2021-12-07 21:25:29', 1, 'Firefox 95.0', 'Windows', '127.0.0.1'),
(9, '2021-12-07 22:15:41', 2, 'Firefox 95.0', 'Windows', '127.0.0.1'),
(10, '2021-12-08 04:40:13', 1, 'Firefox 95.0', 'Windows', '127.0.0.1'),
(11, '2021-12-08 04:49:18', 2, 'Firefox 95.0', 'Windows', '127.0.0.1'),
(12, '2021-12-22 14:03:39', 1, 'Firefox 95.0', 'Windows', '127.0.0.1'),
(13, '2021-12-22 14:08:44', 1, 'Firefox 95.0', 'Windows', '127.0.0.1'),
(14, '2021-12-22 14:09:08', 1, 'Firefox 95.0', 'Windows', '127.0.0.1');
...
--
ALTER TABLE `facets`
  MODIFY `facet_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `facets_signed`
  MODIFY `signed_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
