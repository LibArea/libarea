...
namespace Modules\Search\App\Wamania;
...
class Spanish extends Stem
{
    ...
    private function step1()
    {
        ...
        if (($position = $this->search(array(
            ...
            'ible', 'ables', 'able', 'ismos', 'ismo', 'icas', 'icos', 'ica', 'ico', 'anzas', 'anza'
        ))) != false) {
        ...
        if (($position = $this->search(array(
            'adoras', 'adora', 'aciones', 'ación', 'adores', 'ador', 'antes', 'ante', 'ancias', 'ancia'
        ))) != false) {
    ...
    private function step2a()
    {
        ...
        if (($position = $this->searchIfInRv(array(
            'yamos', 'yendo', 'yeron', 'yan', 'yen', 'yais', 'yas', 'yes', 'yo', 'yó', 'ya', 'ye'
        ))) != false) {
