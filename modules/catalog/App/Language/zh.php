...
$data = [
    ...
    'results.search'        => '網站：約。',
    'no.search.results'     => '搜索沒有返回任何結果。 <br>搜索查詢太短/太長',
    'empty.request'         => '空搜索詞',
    ...
    'software'              => '程式',
    'reference.info'        => '參考信息',
    'reference.help'        => '百科全書、參考書',
    'science.education'     => '科學與教育',
    ...
    'web.top.view'          => '按评级划分',
    'web.view'              => '新网站',
    'web.audits.view'       => '需要考虑',
    'web.bookmarks.view'    => '我的书签',
    'web.deleted.view'      => '已删除',
