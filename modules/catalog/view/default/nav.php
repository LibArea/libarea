...
if ($category) { ?>
  ...
  <p>
    ...
    <span class="right mr30">
      <a class="<?php if ($data['sheet'] == 'web.all') { ?>bg-gray-100 p5 gray-600 <?php } ?>mr20" href="<?= getUrlByName('web.dir.all', ['slug' => $category['facet_slug']]); ?>">
        <?= Translate::get('by.date'); ?>
      </a>
      <a class="<?php if ($data['sheet'] == 'web.top') { ?>bg-gray-100 p5 gray-600 <?php } ?>" href="<?= getUrlByName('web.dir.top', ['slug' => $category['facet_slug']]); ?>">
        TOP
      </a>
    </span>
  </p>
