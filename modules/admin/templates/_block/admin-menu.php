<aside>
    ...
    <ul class="admin-menu">
        ...
        <li class="nav<?php if ($data['sheet'] == 'all' || $data['sheet'] == 'approved') { ?> active<?php } ?>">
            <a class="light-gray" title="<?= lang('Audit'); ?>" href="/admin/audit">
        ...
        <li class="nav<?php if ($data['sheet'] == 'comments') { ?> active<?php } ?>">    
        ...
        <li class="nav<?php if ($data['sheet'] == 'answers') { ?> active<?php } ?>">
        ...
        <li class="nav<?php if ($data['sheet'] == 'domains') { ?> active<?php } ?>">
            <a class="light-gray" title="<?= lang('Domains'); ?>" href="/admin/domains">
