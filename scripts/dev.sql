...
CREATE TABLE `audits` (
  `id` int NOT NULL,
  `action_type` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `type_belonging` varchar(16) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'audit' COMMENT 'audit or repost)',
...
CREATE TABLE `badges` (
  ...
  `badge_icon` varchar(550) COLLATE utf8mb4_general_ci NOT NULL,
  `badge_tl` int DEFAULT NULL,
  `badge_score` int DEFAULT NULL,
  `badge_title` varchar(150) COLLATE utf8mb4_general_ci NOT NULL,
  `badge_description` varchar(500) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, '<span title=\"Сообщил об ошибке, которое понравилось команде сайта.\"><svg class=\"icons red\" width=\"24\" height=\"24\"><use xlink:href=\"/assets/svg/icons.svg#bug\"></use></svg></span>', 0, 0, 'Тестер', 'Сообщение об ошибке, которое понравилось команде сайта.');
...
CREATE TABLE `badges_user` (
  `bu_id` int NOT NULL,
  `bu_badge_id` int NOT NULL,
  `bu_user_id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `comments` (
  ...
  `comment_modified` timestamp NOT NULL DEFAULT '2020-12-30 15:00:00',
  ...
  `comment_lo` int NOT NULL DEFAULT '0',
...
(1, 3, 0, 1, '2021-04-27 16:41:27', '2020-12-28 21:00:00', 1, 0x3132372e302e302e31, 0, 'Первый ответ в теме', 0, 0, 0),
(2, 1, 0, 2, '2021-06-29 19:34:52', '2021-08-14 10:50:53', 1, 0x3132372e302e302e31, 0, 'Интересно, спасибо. Вы забыли указать, что можно задавать вопросы в чате (ссылка в footer) этого сайта.', 0, 0, 0);
...
CREATE TABLE `facets` (
  ...
  `facet_title` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `facet_description` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `facet_short_description` varchar(160) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `facet_info` text COLLATE utf8mb4_general_ci,
  `facet_slug` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `facet_img` varchar(255) COLLATE utf8mb4_general_ci DEFAULT 'facet-default.png',
  `facet_cover_art` varchar(255) COLLATE utf8mb4_general_ci DEFAULT 'cover_art.jpeg',
  `facet_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `facet_seo_title` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `facet_post_related` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `facet_type` varchar(32) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'topic' COMMENT 'Topic, Group or Blog...',
...
CREATE TABLE `facets_types` (
  ...
  `type_lang` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `type_title` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `files` (
  ...
  `file_type` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(1, '2021/c-1638777119.webp', 'post', 0, 1, '2021-12-05 01:52:00', 0);
...
CREATE TABLE `folders_relation` (
  `id` int NOT NULL,
  `folder_id` int NOT NULL COMMENT 'ID папки (folders)',
  `action_type` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Тип контента',
  `tid` int NOT NULL COMMENT 'id контента',
  `user_id` int NOT NULL COMMENT 'id кто добавил'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `invitations` (
  ...
  `uid` int DEFAULT '0',
  `invitation_code` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `invitation_email` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `invitation_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `add_ip` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `active_expire` tinyint(1) DEFAULT '0',
  `active_time` datetime DEFAULT NULL,
  `active_ip` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `messages` (
  ...
  `message_sender_id` int DEFAULT NULL COMMENT 'Отправитель',
  `message_dialog_id` int DEFAULT NULL,
...
CREATE TABLE `messages_dialog` (
  ...
  `dialog_sender_id` int DEFAULT NULL COMMENT 'Отправитель',
  `dialog_sender_unread` int DEFAULT NULL COMMENT 'Отправитель, 0 непрочитано',
  `dialog_recipient_id` int DEFAULT NULL COMMENT 'Получатель',
  `dialog_recipient_unread` int DEFAULT NULL COMMENT 'Получатель, 0 непрочитано',
  ...
  `dialog_sender_count` int DEFAULT NULL COMMENT 'Отправитель кол.',
  `dialog_recipient_count` int DEFAULT NULL COMMENT 'Получатель кол.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `notifications` (
  `id` int NOT NULL,
  `sender_id` int DEFAULT NULL COMMENT 'Отправитель',
  `recipient_id` int DEFAULT '0' COMMENT 'Получает ID',
  `action_type` int DEFAULT NULL COMMENT 'Тип оповещения',
  `url` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'URL источника',
  `add_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `read_flag` tinyint(1) DEFAULT '0' COMMENT 'Состояние прочтения',
  `is_deleted` tinyint UNSIGNED DEFAULT '0' COMMENT 'Удаление'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `polls` (
  ...
  `poll_title` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `poll_user_id` int NOT NULL,
...
CREATE TABLE `polls_answers` (
  ...
  `answer_title` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `answer_votes` int DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `polls_votes` (
  ...
  `vote_ip` varchar(15) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `posts` (
  ...
  `post_slug` varchar(128) COLLATE utf8mb4_general_ci NOT NULL,
  `post_type` varchar(32) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'article' COMMENT 'Article, post, question, page, note...',
  `post_translation` smallint NOT NULL DEFAULT '0',
  `post_draft` smallint NOT NULL DEFAULT '0',
  ...
  `post_after` smallint NOT NULL DEFAULT '0' COMMENT 'id первого ответа',
  `post_votes` smallint NOT NULL DEFAULT '0',
  `post_karma` smallint NOT NULL DEFAULT '0',
  `post_comments_count` int DEFAULT '0',
  `post_hits_count` int DEFAULT '0',
  `post_content` text COLLATE utf8mb4_general_ci NOT NULL,
  `post_content_img` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `post_thumb_img` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `post_related` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `post_merged_id` int NOT NULL DEFAULT '0' COMMENT 'id с чем объединен',
  ...
  `post_poll` smallint NOT NULL DEFAULT '0' COMMENT 'Для опросов',
  `post_tl` smallint NOT NULL DEFAULT '0' COMMENT 'Видимость по уровню доверия',
  `post_lo` int NOT NULL DEFAULT '0' COMMENT 'Id лучшего ответа',
  `post_top` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1 - пост поднят',
  `post_hidden` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Скрытый пост',
  `post_url` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `post_url_domain` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `post_focus_count` int DEFAULT '0',
...
CREATE TABLE `posts_view` (
  ...
  `view_post_id` int DEFAULT NULL,
  `view_user_id` int DEFAULT NULL,
...
(1, 3, 1, '2024-03-02 17:01:04'),
(2, 8, 1, '2025-03-27 23:37:03'),
(3, 9, 1, '2025-03-27 23:38:15'),
(4, 10, 1, '2025-03-27 23:39:52'),
(5, 6, 1, '2025-03-27 23:40:20'),
(6, 11, 1, '2025-03-27 23:47:22');
...
CREATE TABLE `search_logs` (
  ...
  `action_type` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Catalog, site...',
  `add_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `add_ip` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `user_id` int NOT NULL DEFAULT '0',
...
CREATE TABLE `stop_words` (
  ...
  `stop_word` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `stop_add_uid` int NOT NULL DEFAULT '0' COMMENT 'Кто добавил',
  `stop_space_id` int NOT NULL DEFAULT '0' COMMENT '0 - глобально',
...
CREATE TABLE `users` (
  ...
  `reg_ip` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `template` varchar(12) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'default',
  `lang` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'ru',
  `scroll` tinyint(1) NOT NULL DEFAULT '0',
  `whisper` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `avatar` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'noavatar.png',
  `cover_art` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'cover_art.jpeg',
  `color` varchar(12) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '#f56400',
  `about` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `website` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `location` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `public_email` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `github` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `skype` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `twitter` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `telegram` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `vk` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `users_action_logs` (
  ...
  `user_login` varchar(50) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'User login',
  `id_content` int NOT NULL COMMENT 'Content ID',
  `action_type` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `action_name` varchar(124) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Action name',
  `url_content` varchar(250) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'URL content',
...
(1, 1, 'AdreS', 8, 'post', 'added', '/posts/8/post-28-03-2025', '2025-03-27 23:37:02'),
(2, 1, 'AdreS', 9, 'post', 'added', '/notes/9/bolshie-yazykovye-modeli-kak-instrument-dlya-analiza-tehnicheskoy-dokumentacii-i-resheniya', '2025-03-27 23:38:14'),
(3, 1, 'AdreS', 10, 'post', 'added', '/question/10/naskolko-vam-nravitsya-sayt-habr', '2025-03-27 23:39:52'),
(4, 1, 'AdreS', 11, 'page', 'added', '/mod/admin/facets', '2025-03-27 23:45:22');
...
CREATE TABLE `users_activate` (
  ...
  `activate_code` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `users_agent_logs` (
  ...
  `user_browser` varchar(64) COLLATE utf8mb4_general_ci NOT NULL,
  `user_os` varchar(64) COLLATE utf8mb4_general_ci NOT NULL,
  `user_ip` varchar(64) COLLATE utf8mb4_general_ci NOT NULL,
...
(1, '2021-09-19 13:09:38', 1, 'Firefox 92.0', 'Windows', '127.0.0.1', NULL),
(2, '2021-09-19 13:57:57', 2, 'Chrome 93.0.4577.82', 'Windows', '127.0.0.1', NULL),
(3, '2021-10-17 07:43:05', 1, 'Firefox 93.0', 'Windows', '127.0.0.1', NULL),
(4, '2021-10-25 12:24:03', 1, 'Firefox 93.0', 'Windows', '127.0.0.1', NULL),
(5, '2021-11-03 23:01:34', 1, 'Firefox 94.0', 'Windows', '127.0.0.1', NULL),
(6, '2021-12-04 15:38:15', 1, 'Firefox 94.0', 'Windows', '127.0.0.1', NULL),
(7, '2021-12-05 01:51:36', 1, 'Firefox 94.0', 'Windows', '127.0.0.1', NULL),
(8, '2021-12-06 21:25:29', 1, 'Firefox 95.0', 'Windows', '127.0.0.1', NULL),
(9, '2021-12-06 22:15:41', 2, 'Firefox 95.0', 'Windows', '127.0.0.1', NULL),
(10, '2021-12-07 04:40:13', 1, 'Firefox 95.0', 'Windows', '127.0.0.1', NULL),
(11, '2021-12-07 04:49:18', 2, 'Firefox 95.0', 'Windows', '127.0.0.1', NULL),
(12, '2021-12-21 14:03:39', 1, 'Firefox 95.0', 'Windows', '127.0.0.1', NULL),
(13, '2021-12-21 14:08:44', 1, 'Firefox 95.0', 'Windows', '127.0.0.1', NULL),
(14, '2021-12-21 14:09:08', 1, 'Firefox 95.0', 'Windows', '127.0.0.1', NULL),
(15, '2022-02-09 08:50:18', 1, 'Firefox 96.0', 'Windows', '127.0.0.1', NULL),
(16, '2025-03-27 23:35:44', 1, 'Firefox 115.0', 'Windows', '127.0.0.1', '687811917');
...
CREATE TABLE `users_auth_tokens` (
  ...
  `auth_selector` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `auth_hashedvalidator` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `users_email_activate` (
  ...
  `user_id` int NOT NULL,
  `email_code` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `users_setting` (
  ...
  `setting_user_id` int UNSIGNED NOT NULL,
  `setting_email_pm` tinyint UNSIGNED DEFAULT NULL COMMENT 'Написал ПМ',
  `setting_email_appealed` tinyint UNSIGNED DEFAULT NULL COMMENT 'Обратился @',
  `setting_email_post` tinyint UNSIGNED DEFAULT NULL COMMENT 'Написал пост',
  `setting_email_answer` tinyint UNSIGNED DEFAULT NULL COMMENT 'Ответил'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `votes_comment` (
  `votes_comment_id` int NOT NULL,
  `votes_comment_item_id` int NOT NULL,
  `votes_comment_points` int NOT NULL,
  `votes_comment_ip` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `votes_comment_user_id` int NOT NULL DEFAULT '1',
...
CREATE TABLE `votes_post` (
  `votes_post_id` int NOT NULL,
  `votes_post_item_id` int NOT NULL,
  `votes_post_points` int NOT NULL,
  `votes_post_ip` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `votes_post_user_id` int NOT NULL DEFAULT '1',
...
(1, 2, 1, '127.0.0.1', 1, '2021-08-15 22:29:32');
...
--
ALTER TABLE `badges_user`
  MODIFY `bu_id` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `invitations`
  MODIFY `invitation_id` int UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `messages_dialog`
  MODIFY `dialog_id` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `posts`
  MODIFY `post_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT для таблицы `posts_signed`
--
ALTER TABLE `posts_signed`
  MODIFY `signed_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `votes_comment`
  MODIFY `votes_comment_id` int NOT NULL AUTO_INCREMENT;
