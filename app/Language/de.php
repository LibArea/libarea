...
$data = [
    ...
    'notif.add.pm'              => 'hat dir geschrieben {url}private Nachricht{a}',
    'notif.add.comment'         => 'geantwortet {url}Deine Antwort{a}',
    'notif.add.comment.comment' => 'geantwortet {url}dein Kommentar{a}',
    'notif.add.answer'          => 'geantwortet {url}deine Post{a}',
    'notif.add.flag'            => 'eingeschrieben {url}Beschwerde{a}',
    'notif.add.audit'           => 'Rechnungsprüfung erforderlich {url}Inhalt{a}',
    'notif.references.post'     => 'hat dich in einem {url}Beitrag erwähnt{a}',
    'notif.references.amswer'   => 'hat Sie in einer {url}Antwort erwähnt{a}',
    'notif.references.comment'  => 'dich in einem {url}Kommentar erwähnt{a}',
    'notif.add.website'         => 'Seite hinzugefügt  {url}Schlag es nach{a}',
    'notif.edit.website'        => 'Website geändert, {url}Hör zu{a}',
    'notif.approved.website'    => '(Moderator ) {url}hat Ihre Website geändert (genehmigt){a}',
    'notif.add.website.comment' =>'{url}die Seite kommentiert, die Sie{a} abonniert haben',
    ...
    'english'                       => 'English',
    'if.fill.then.page'             => 'Wenn ausgefüllt, dann wird der Beitrag eine Seite (in der Dokumentation)',
