...
$data = [
    ...
    'recommended-posts' => 'Рекомендованные посты в «%1$s» отобранные в ручную. ',

    'topics-all'            => 'Все темы',
    'topics-my'             => 'Я подписан на темы',
    'topics-new'            => 'Новые темы',
    'topics-desc-all'       => 'Страница тем, расположенных в порядке популярности. По количеству расположенных постов',
    'topics-desc-my'        => 'Страница тем, на которые я подписан',
    'topics-desc-new'       => 'Новые темы добавленные на сайте за последнее время. Подпишись на темы',
    ...
    <p>Этот сайт состоит из <a href="/topics">Тем</a>.</p>
    <p><i class="icon-lightbulb red"></i> Чтобы видеть посты в ленте, <b>вам необходимо <a href="/topics">подписаться</a></b> на интересные вам темы.</p>
    <p><b>Кстати...</b></p>
