...
return [
    ...
    'data_help'         => '<i class="gray-600">Формат заголовка:</i><br> «LibArea» — спільнота<br><br><i class="gray-600">Опис (без реклами):</i><br> ... Що є на сайті?<i>',
