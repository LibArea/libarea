...
return [
    ...
    'view_policy'       => 'Тільки учасники можуть бачити контент',
    ...
    'subscribers_only'  => 'Тільки передплатники можуть читати цей блог...',
    ...
    'ru_language'       => 'Російська',
    'ua_language'       => 'Український',
    'en_language'       => 'Англійська',
    'de_language'       => 'Німецька',
    'fr_language'       => 'Французька',
    'zh_TW_language'    => 'Традиційний китайський',
    'zh_CN_language'    => 'Спрощена китайська',
    'ro_language'       => 'Румунський',
    'ar_language'       => 'Арабська',
    ...
    'rec_posts_desc'    => 'Рекомендовані пости в «{name}» відібрані вручну. ',
