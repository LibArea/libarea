...
return [
    ...
    'id_merged'            => 'ID посту, з ким буде об\'єднаний цей пост',
    'id_merged_info'      => 'Це важлива дія. Знайдіть ID поста вручну. 0 - скасувати об\'єднання',
    ...
    'note'                 => 'Примітка',
    'notes'             => 'Нотатки',
    'add_article'         => 'Написати статтю',
    'add_post'             => 'Написати пост',
    'add_question'         => 'Задати питання',
    'add_note'             => 'Примітка через URL',
    'add_page'             => 'Додати сторінку',
    'edit_article'         => 'Змінити статтю',
    'edit_note'         => 'Змінити нотатку',
    ...
    'english'           => 'англійська',
    'info_page'            => 'Для документації',
    'work_email'        => 'Робочий e-mail (для <b>активації</b> облікового запису)',

    'view_content_tl'    => 'Хто може переглядати (з якого TL)',
    ...
    'refine_your_search'    => 'є ще. Уточніть пошук.',
