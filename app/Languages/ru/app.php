...
return [
    ...
    'id_merged'            => 'ID, с кем будет объединен',
    'id_merged_info'    => 'Важно! Найдите ID контента в ручном режиме. 0 - отменить объединение',
    ...
    'english'           => 'английский',
    'info_page'         => 'Для документации',
    'work_email'        => 'Рабочий е-mail (для <b>активации</b> аккаунта)',

    'view_content_tl'    => 'Кто может просматривать (с какого TL)',
    ...
    'refine_your_search'    => 'есть ещё. Уточните поиском.',
