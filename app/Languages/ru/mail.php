...
return [
  ...
  'changing.password_message'  => '<p>Ваша ссылка для изменения пароля:</p><p>{url}</p>',
  ...
  'footer' => '<p>Это письмо создано автоматически.<br>Отвечать на него не надо.<br>Администрация.<br>{name}</p>',
