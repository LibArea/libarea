...
return [
    ...
    'notifications_info'    => 'Вы можете пометить все объявления, как прочитанные, нажать на кнопку: «Прочитал».',
    'notification_info'     => 'Вы можете отписаться от всех уведомлений на E-mail в этом разделе.',

    'add_post'              => 'Постарайтесь писать с надлежащим  оформлением, для лучшего чтения.',
	'add_article' 			=> 'Используйте тэг <b>cut</b>: кнопка <svg class="icon"><use xlink:href="/assets/svg/icons.svg#cut"></use></svg> <br><br> Он скрывает под кат часть текста, следующую за тегом (будет написано «Читать дальше»).',
	'add_question' 			=> 'Вопрос начинается с Большой буквы и заканчивается знаком вопроса (?).',
	'add_note'				=> 'Если парсинг завершился не совсем удачно. В ручную заполните необходимые поля.',
	'add_page'				=> 'Это официальная документация. Постарайтесь писать без ошибок.',
	
	'edit_question' 		=> 'Вопрос должен быть вопросом, он не утверждение и не заявление.',
	'edit_note' 			=> 'Вы можете отредактировать название и описание более детально.',
	'edit_article'			=> 'Структурированная статья смотрится лучше.',
    ...
    'add_topic'             => 'Тема — то узел (для навигации), используемый системой для организации контента. Тема является единой точкой ввода, интерпретацией различных вещей, явлений и других понятий.',
    'add_blog'              => 'Придумайте уникальный URL (SLUG) на англ. языке в нижнем регистре.',
