...
class SearchModel extends \MainModel
{
    ...
    {
        $sql = "SELECT post_id, post_slug, post_space_id, post_title, post_content  FROM posts WHERE post_content LIKE :qa1 OR post_title LIKE :qa2 ORDER BY post_id LIMIT 15";
