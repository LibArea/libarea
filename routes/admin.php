...
Route::before('Designator', [UserData::REGISTERED_ADMIN, '='])->getGroup();
    ...
    Route::get('/web/deleted')->controller('Item\WebController', ['web.deleted', 'web'])->name('web.deleted');
    Route::get('/web/deleted/page/{page?}')->controller('Item\WebController', ['web.deleted', 'web'])->where(['page' => '[0-9]+']);
